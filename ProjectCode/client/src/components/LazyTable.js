...
export default function LazyTable({ route, selectedField, columns, defaultPageSize, rowsPerPageOptions }) {
  ...
  useEffect(() => {
    fetch(`${route}?field=${encodeURIComponent(selectedField)}&page=${page}&limit=${pageSize}`)
      .then(res => res.json())
      .then(resJson => setData(resJson));
  }, [route, selectedField, page, pageSize]);

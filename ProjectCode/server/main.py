...
# ========== Event Group Endpoints (iOS-style folder grouping) ==========

@app.post("/api/events/groups/merge", response_model=EventGroupMergeResponse)
...
@app.post("/api/events/{event_id}/remove-from-group")
...
@app.get("/api/events/highlights/grouped", response_model=HighlightsGroupedResponse)
...
@app.put("/api/events/groups/{parent_id}/name")
...
@app.post("/api/events/groups/{parent_id}/undo-merge")
